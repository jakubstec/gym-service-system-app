    ...
    public static List<TrainingSession> InitializeSchedule()
    {
        ...
        for (int dayOffset = 0; dayOffset < 7; dayOffset++)
        {
            ...
            if (dayOfWeek >= 1 && dayOfWeek <= 5)
            {
                ...
                {
                    case 1:
                        sessions.Add(SessionFactory.CreateGroupClass("Joga Poranna", "Ola", dayOffset, 9.0, 90));
                        sessions.Add(SessionFactory.CreateGroupClass("Zumba", "Kasia", dayOffset, 18.0, 90));
                        break;
                    case 2:
                        sessions.Add(SessionFactory.CreateGroupClass("Pilates", "Ola", dayOffset, 10.5, 120));
                    ...
                    case 3:
                        ...
                        sessions.Add(SessionFactory.CreateGroupClass("HIIT Express", "Kasia", dayOffset, 14.0, 120));
                        break;
                    case 4:
                        sessions.Add(SessionFactory.CreateGroupClass("Pilates", "Ola", dayOffset, 10.5, 120));
